...
public class DozeSettingsFragment extends PreferenceFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mAmbientDisplaySwitch.setChecked(MoKeeActionsSettings.isDozeEnabled(getActivity().getContentResolver()));
        ...
        mSwitchBarText.setText(MoKeeActionsSettings.isDozeEnabled(getActivity().getContentResolver()) ? R.string.switch_bar_on :
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        boolean dozeEnabled = MoKeeActionsSettings.isDozeEnabled(getActivity().getContentResolver());
